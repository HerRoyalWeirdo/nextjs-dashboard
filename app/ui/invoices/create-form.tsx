...
//import { useActionState } from 'react'; //chapter 14 - cannot find useActionState
...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  return (
    //<form action={createInvoice}> chatpter 14
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          {/* why does this message not pop up? - the required stopped it*/}
